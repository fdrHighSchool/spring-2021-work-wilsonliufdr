/* Notes: If there is multiple subclass that inherits from the superclass it is called inheritance hierarchy
A superclass reference variable can hold an object of that superclass or of any of its subclasses, this is a type of polymorphism.
 */
